...
class Digitalbits_Imageoptimiser_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function compareList() {
        ...
        $valores = Mage::getModel('imageoptimiser/imageoptimiser')->getCollection()->getImages();
